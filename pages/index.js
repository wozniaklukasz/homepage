...
export default function Home() {
  return (
    <Layout>
      <Seo
        title={siteTitle}
        description={`${siteTitle} homepage. This is my personal website where I write about stuff I'm working with, new things I want to learn, and some personal thoughts.`}
      />
      ...
      <section className={utilStyles.headingMd}>
        <p>
          I am a software developer specialized in React, Redux, and TypeScript.
          Read more{" "}
          <Link href="/about">
            <a>about me</a>
          </Link>
        ...
        <p>
          ...
          where I write about stuff I&apos;m working with, new things I want to
          learn, and some personal thoughts.
        </p>
        <p>
          ...
          or{" "}
          <a
            href="https://www.linkedin.com/in/wozniaklukaszg/"
            target="linkedin"
          >
            LinkedIn
          </a>
