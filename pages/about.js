...
export default function About() {
  return (
    <Layout>
      <Seo title={`About | ${siteTitle}`} description={`${siteTitle} about page.`} />
      <h1 className={utilStyles.heading2Xl}>About me</h1>
      <section>
        <h2>Professional experience</h2>
        <p>I started working as a software developer when I was a student in July 2014. I did a one-year internship as
          a .NET
        ...
        <i className={utilStyles.lightText}>
          In October 2018, I had the opportunity to go with my team for a workation to work from sunny Malta.
        </i>
        <p>In 2017 I defended my Master's thesis <i>"Comparative analysis of selected methods of testing the usability
          ...
          full-time job as a Front-end developer. I made an application for internal use of the company in Angular.</p>
        <p>At the beginning of 2018, I started to use React and Redux. I had the opportunity to create 3 React
          ...
          applications. As a member of the interdisciplinary scrum team, I cooperated with Java developers,
      ...
      <section>
        ...
        <p>During the winter I go snowboarding. In the summer I sail. During the year you can meet me at the gym
          (recently I started learning to weightlifting). I like cooking and eating some good food (sushi, pizza
